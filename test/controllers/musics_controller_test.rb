...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { album_id: @music.album_id, artist_id: @music.artist_id, location: @music.location, music_id: @music.music_id, name: @music.name, resource_id: @music.resource_id }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { album_id: @music.album_id, artist_id: @music.artist_id, location: @music.location, music_id: @music.music_id, name: @music.name, resource_id: @music.resource_id }
    assert_redirected_to music_path(assigns(:music))
  end
